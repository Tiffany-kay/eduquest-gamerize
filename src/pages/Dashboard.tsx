...
import { ArrowRight, Brain, ChevronRight, Coins, Star, Zap } from "lucide-react";
      ...
      <main className="container max-w-5xl mx-auto pt-24 px-4 pb-16">
        ...
        <div className="mb-10">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button variant="ghost" size="sm" onClick={() => navigate("/modules")} className="gap-1">
              ...
              {recommendedModules.length > 0 ? (
                ...
                <div className="text-center py-12 bg-muted/30 rounded-xl border">
                  ...
                  <Button onClick={() => navigate("/modules")}>
                    Review All Modules <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
              )}
            </>
